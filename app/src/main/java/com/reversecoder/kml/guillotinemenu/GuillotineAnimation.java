...
public class GuillotineAnimation {
	...
	private GuillotineAnimation(GuillotineBuilder builder) {
		...
		this.mOpeningView = builder.openingView;
		this.mClosingView = builder.closingView;
	...
	private ObjectAnimator buildOpeningAnimation() {
		ObjectAnimator rotationAnimator = initAnimator(
				ObjectAnimator.ofFloat(mGuillotineView, ROTATION, GUILLOTINE_CLOSED_ANGLE, GUILLOTINE_OPENED_ANGLE));
	...
	private ObjectAnimator buildClosingAnimation() {
		ObjectAnimator rotationAnimator = initAnimator(
				ObjectAnimator.ofFloat(mGuillotineView, ROTATION, GUILLOTINE_OPENED_ANGLE, GUILLOTINE_CLOSED_ANGLE));
	...
	private void startActionBarAnimation() {
		ObjectAnimator actionBarAnimation = ObjectAnimator.ofFloat(mActionBarView, ROTATION, GUILLOTINE_OPENED_ANGLE,
				ACTION_BAR_ROTATION_ANGLE);
		actionBarAnimation.setDuration((long) (mDuration
				* (GuillotineInterpolator.FIRST_BOUNCE_TIME + GuillotineInterpolator.SECOND_BOUNCE_TIME)));
	...
	public static class GuillotineBuilder {
		...
		public GuillotineBuilder(View guillotineView, View closingMenuView, View openingMenuView) {
			this.guillotineView = guillotineView;
			this.openingView = openingMenuView;
			this.closingView = closingMenuView;
		}
