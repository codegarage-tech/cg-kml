...
public class AdvancedRecyclerViewWithWaveSwipeRefreshLayout extends FrameLayout {
    ...
    public AdvancedRecyclerViewWithWaveSwipeRefreshLayout(Context context) {
        super(context);
        initView();
    }

    public AdvancedRecyclerViewWithWaveSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public AdvancedRecyclerViewWithWaveSwipeRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout.layout_progress_wave_refresh_recyclerview, this);
        mPtrLayout = (WaveSwipeRefreshLayout) v.findViewById(R.id.ptr_layout);
        mPtrLayout.setColorSchemeColors(Color.WHITE, Color.WHITE);
        mPtrLayout.setWaveColor(Color.argb(100,255,0,0));
    ...
    public static class EasyDataObserver extends AdapterDataObserver {
        ...
        public EasyDataObserver(AdvancedRecyclerViewWithWaveSwipeRefreshLayout recyclerView) {
    ...
    public void setSwipeEnable(final boolean isSwipeEnable){
        if(isSwipeEnable){
            mPtrLayout.setEnabled(true);
        }else{
            mPtrLayout.setEnabled(false);
