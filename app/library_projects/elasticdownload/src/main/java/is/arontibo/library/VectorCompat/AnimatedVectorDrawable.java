...
public class AnimatedVectorDrawable extends DrawableCompat implements Animatable, Tintable {
    ...
    public void setAnimatedVectorDrawableLayoutDirection(int layoutDirection) {
        mAnimatedVectorState.mVectorDrawable.setDrawableCompatLayoutDirection(layoutDirection);
    }
