...
public class DraggableView extends RelativeLayout {
  ...
  private static final int DEFAULT_SCALE_FACTOR = 2;//2
  private static final int DEFAULT_TOP_VIEW_MARGIN = 30;//30
  private static final int DEFAULT_TOP_VIEW_HEIGHT = -1;//-1
